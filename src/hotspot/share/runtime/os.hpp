...
class os: AllStatic {
 ...
 private:
  ...
  static char*  pd_attempt_reserve_memory_at(size_t bytes, char* addr, int file_desc, bool executable);
 ...
 public:
  ...
  static char*  reserve_memory(size_t bytes, char* addr = 0,
                               size_t alignment_hint = 0, int file_desc = -1, bool executable = false);
  static char*  reserve_memory(size_t bytes, char* addr,
                               size_t alignment_hint, MEMFLAGS flags, bool executable = false);
  static char*  reserve_memory_aligned(size_t size, size_t alignment, int file_desc = -1, bool executable = false);
  static char*  attempt_reserve_memory_at(size_t bytes, char* addr, int file_desc = -1, bool executable = false);
